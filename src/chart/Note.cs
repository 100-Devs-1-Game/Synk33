...
public abstract record Note(NoteTime StartTime, NoteType Type) {
    public readonly long Bar = StartTime.Bar;
    public readonly long Beat = StartTime.Beat;
...
public record NoteTime(long Bar, long Beat, double Sixteenth) {
    public readonly long Bar = Bar;
    public readonly long Beat = Beat;
    ...
    public float ToMilliseconds(long notesBerBar, double secondsPerBeat) {
